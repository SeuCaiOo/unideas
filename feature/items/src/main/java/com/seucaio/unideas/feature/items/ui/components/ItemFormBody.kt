...
/**
 * Field set + save action shared by `ItemScreen` (edit) and `ItemFormSheet` (create) (#86/#97):
 ...
 * specific ViewModel's own state/event types, so both `ItemFormViewModel` (create/edit) and
