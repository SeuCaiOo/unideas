 ...
 * scans every item with a due date, buckets each by [ReminderTier.of], and refreshes the two
 * aggregated notifications. Radar tier needs no notification — already surfaced by the priority
 * panel.
 */
