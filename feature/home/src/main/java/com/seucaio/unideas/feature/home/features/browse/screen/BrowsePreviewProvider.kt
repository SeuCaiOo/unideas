...
internal data class BrowsePreviewFixture(
    val itemsState: BrowseItemsState,
    val filterState: FilterState,
    val hasAnyItem: Boolean,
)

internal class BrowsePreviewProvider : PreviewParameterProvider<BrowsePreviewFixture> {
    ...
    override val values: Sequence<BrowsePreviewFixture> = sequenceOf(
        ...
        BrowsePreviewFixture(
            itemsState = BrowseItemsState(tabItems = emptyList(), groupedTabItems = emptyList()),
            filterState = FilterState(
